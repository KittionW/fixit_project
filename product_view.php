...
<div class="border_control">
  ...
  <div class="control_image_de">
    <img class="pro_image_detail" src="image/image_cover/<?php echo $run['imagecover']?>" />
  </div>

  <div class="product">
    <h1 class="text_pro_de1"><?php echo $run['title']; ?></h1>
    <h2 class="text_pro_de3">฿<?php echo number_format($run['price'])?></h2>
    <p class="desc text_pro_de2"><?php echo $run['description']; ?></p>
    <div>
      <a href="add_cart.php?code=<?php echo $run['product_code']; ?> &title=<?php echo $run['title']; ?> &price=<?php echo $run['price']; ?>&img_cc=<?php echo $run['imagecover']; ?>">
      <button class="add button_pro"><?= __('Add to Cart')?></button></a>
    </div>
  </div>
